...
gSounds = {
    ['field-music'] = love.audio.newSource('sounds/world.mp3','static'),
    ['battle-music'] = love.audio.newSource('sounds/battle.mp3','static'),
    ...
    ['intro-music'] = love.audio.newSource('sounds/menu.mp3','static')
}